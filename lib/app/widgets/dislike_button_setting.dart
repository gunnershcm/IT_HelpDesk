...
class DisLikeButton extends StatefulWidget {
  ...
  /// call back of first frame with DisLikeButtonState
  final Function(DisLikeButtonState state)? postFrameCallback;

  @override
  State<StatefulWidget> createState() => DisLikeButtonState();
}

class DisLikeButtonState extends State<DisLikeButton> with TickerProviderStateMixin {
