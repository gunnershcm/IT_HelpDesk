...
import 'package:dich_vu_it/app/widgets/dialogs.dart';
...
import 'chat.card/chat_user_card.dart';
...
class _State extends State<ListChatScreen> {
    ...
    return GestureDetector(
      ...
      child: WillPopScope(
        ...
        child: Scaffold(
          //app bar
          appBar: AppBar(
            backgroundColor: Color.fromARGB(255, 174, 223, 239),
            leading: const Row(),
            title: _isSearching
                ? TextField(
    ...
    showDialog(
        ...
        builder: (_) => AlertDialog(
              ...
              content: TextFormField(
                ...
                decoration: InputDecoration(hintText: 'Email', prefixIcon: const Icon(Icons.email, color: Colors.blue), border: OutlineInputBorder(borderRadius: BorderRadius.circular(15))),
              ),
