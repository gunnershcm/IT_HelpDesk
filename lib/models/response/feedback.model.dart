...
class FeedbackModel {
  ...
  factory FeedbackModel.fromMap(Map<String, dynamic> map) {
    return FeedbackModel(
      ...
      user: map['user'] != null
          ? UserLoginResponseModel.fromMap(map['user'] as Map<String, dynamic>)
          : null,
    );
  }
  ...
  @override
  String toString() {
    return 'FeedbackModel(id: $id, userId: $userId, solutionId: $solutionId, isPublic: $isPublic, comment: $comment, createdAt: $createdAt, createdAt: $createdAt, modifiedAt: $modifiedAt, user: $user)';
  }
